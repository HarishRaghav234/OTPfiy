...
const LoginForms = () => {
  return (
    <section>
        <div className=' container mx-auto bg-[url(/Images/Turtle-bg.png)] bg-no-repeat bg-right-bottom text-white mt-10 pb-20'>
                ...
                <div className=" p-5 md:w-1/3 rounded-3xl border bg-gradient-to-b from-white/[0.15] to-white/[0.08] border-gray-100 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
                    <div>
                        ...
                        <div className=" text-white text-center">
                            Dont have an Account? <span><a href="">Sign Up</a></span>
                        </div>
                    </div>
                </div>
            </div>
